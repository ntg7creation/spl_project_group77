...
class testfile {
	...
	public static void main(String[] args) {
		...
		//	System.out.println("somthing"+ 6);
			...
			staticFunctions.printStoFail("C:\\Users\\Lenovo\\git\\spl_project_group77\\testfile0", mycustomers);
			Inventory.getInstance().printInventoryToFile("C:\\Users\\Lenovo\\git\\spl_project_group77\\testfile1");
			MoneyRegister.getInstance().printOrderReceipts("C:\\Users\\Lenovo\\git\\spl_project_group77\\testfile2");
