...
public abstract class MicroService implements Runnable {
	 ...
	 * @param <T>
	 *            The type of result expected for the subscribed event.
	 * @param type
	 *            The {@link Class} representing the type of event to subscribe to.
	 * @param callback
	 ...
	 * @param type
	 *            The {@link Class} representing the type of broadcast message to
	 *            subscribe to.
	 * @param callback
	 *            The callback that should be called when messages of type
	 *            {@code type} are taken from this micro-service message queue.
	 ...
	 * 
	 * @param <T>
	 *            The type of the expected result of the request {@code e}
	 * @param e
	 *            The event to send
	 ...
	 * 
	 * @param <T>
	 *            The type of the expected result of the processed event {@code e}.
	 * @param e
	 *            The event to complete.
	 * @param result
	 *            The result to resolve the relevant Future object. {@code e}.
	 */
